...
```{r b05-season-words-plot, echo=FALSE}
plot(
  jitter(sharks$season, amount = 0.08),
  sharks$description_words,
  pch = 19,
  col = rgb(46/255, 116/255, 181/255, 0.28),
  xlab = "Season",
  ylab = "Words in the written dataset description"
)
abline(
  lm(description_words ~ season, data = sharks),
  col = "#604878", lwd = 3
)
```
