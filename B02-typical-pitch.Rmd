...
```{r b02-event-diagrams, echo=FALSE, fig.width=8, fig.height=3.1}
...
draw_outcome_set <- function(selected, title, meaning) {
  ...
  mtext(meaning, side = 3, line = 0.1, cex = 0.82, col = "#4B5563")
  ...
  symbols(x, y, circles = rep(0.25, 12), inches = FALSE,
          bg = ifelse(is_selected, "#00796B", "white"),
          fg = ifelse(is_selected, "#00695C", "#9AA7B2"),
          lwd = 1.4, add = TRUE)
